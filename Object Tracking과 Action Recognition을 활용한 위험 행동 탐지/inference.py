...
def main(
    ...
    model_path='./TubeViT/logs/TubeViT/version_18/checkpoints/epoch=29-step=1230.ckpt',
    annotation_path='./data/test/',
    label_path='./data/test/testlist01.txt',
    num_classes=5,
    batch_size=1,
    frames_per_clip=32,
    video_size=(224, 224),
    ...
    val_set = MyUCF101(
        mode='validation',
        dataframe='/home/rltjq09/VisionAI/data/test/val.csv',
        root=dataset_root,
