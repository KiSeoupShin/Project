...
# path = '/mnt/d/data/training/buying/'
...
# df = pd.read_csv('/mnt/c/Users/tjdus/Desktop/2023-2학기/비전AI와비즈니스/OC_SORT/train.csv')
...
#     fourcc = cv2.VideoWriter_fourcc(*'XVID')  # AVI 파일을 위한 코덱
...
# 사용 예시
root_dir = '/mnt/d/data/temp_val_data/'  # 루트 디렉토리 경로
